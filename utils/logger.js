...
module.exports = class Logger {
	static log (content, type = "info") {
		...
		case "info": {
			return console.log(`${chalk.hex('#000000').bgHex('#00FF00')(` | INFO        ${chalk.hex('#000000').bgHex('#808080')(`[${date}]`)} `)} ${chalk.hex('#00FF00')(content)}`);
		}
		case "warn": {
		...
		case "int": {
			return console.log(`${chalk.hex('#000000').bgHex('#800080')(` | INTERACTION ${chalk.hex('#000000').bgHex('#808080')(`[${date}]`)} `)} ${chalk.hex('#800080')(content)}`);
		}
		case "cmd": {
			return console.log(`${chalk.hex('#000000').bgHex('#FF00FF')(` | MESSAGE     ${chalk.hex('#000000').bgHex('#808080')(`[${date}]`)} `)} ${chalk.hex('#FF00FF')(content)}`);
		}
		case "event": {
			return console.log(`${chalk.hex('#000000').bgHex('#808000')(` | EVENTS      ${chalk.hex('#000000').bgHex('#808080')(`[${date}]`)} `)} ${chalk.hex('#808000')(content)}`);
		}
		case "music": {
			return console.log(`${chalk.hex('#000000').bgHex('#008000')(` | MUSIC       ${chalk.hex('#000000').bgHex('#808080')(`[${date}]`)} `)} ${chalk.hex('#008000')(content)}`);
		}
		case "ready": {
